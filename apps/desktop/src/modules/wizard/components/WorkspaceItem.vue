...
<template>
  <Card
    ...
    :class="workspace.exists !== false ? 'hover:border-primary/50' : 'opacity-60 border-destructive/30'"
    @click="handleOpen"
  >
    <CardContent class="p-0">
      <div class="relative bg-linear-to-br from-primary/10 to-primary/5 h-32 flex items-center justify-center">
        <img
        ...
        >
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" class="h-8 w-8 p-0 bg-background/80 backdrop-blur-sm">
        ...
        >
          <span class="text-destructive font-medium text-sm bg-background/90 px-3 py-1 rounded-full">
            Not Found
          </span>
        </div>
      </div>
