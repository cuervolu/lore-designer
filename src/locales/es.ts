export default {
  ...
  projects: {
    ...
    descriptionPlaceholder: "Háblenos de su proyecto...",
    budget: "Presupuesto",
    ...
    imageUpdateError: "Error al actualizar la imagen del proyecto",
    imageUpdateErrorDescription: "No se pudo actualizar la imagen del proyecto. Por favor, inténtalo de nuevo.",
    dashboard: {
      download: "Descargar",
      ...
      budget: "Presupuesto",
      budgetTotal: "Total del Presupuesto",
  ...
  helpPopover: {
    ...
    reportBug: 'Reportar un Error/Problema',
